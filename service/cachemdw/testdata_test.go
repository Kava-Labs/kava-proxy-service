...
const (
	TestRequestWeb3ClientVersion        testReqName = "web3_clientVersion"
	TestRequestEthGetAccountsEmpty      testReqName = "eth_getAccounts/empty"
	TestRequestEthBlockByNumberSpecific testReqName = "eth_getBlockByNumber"
	TestRequestEthBlockByNumberLatest   testReqName = "eth_getBlockByNumber/latest"
	TestRequestEthBlockByNumberFuture   testReqName = "eth_getBlockByNumber/future"
	TestRequestEthBlockByNumberError    testReqName = "eth_getBlockByNumber/error"
	TestRequestEthGetBalancePositive    testReqName = "eth_getBalance/positive"
	TestRequestEthGetBalanceZero        testReqName = "eth_getBalance/zero"
	TestRequestEthGetCodeEmpty          testReqName = "eth_getCode/empty"
)
...
var testEVMQueries = map[testReqName]testHttpRequestResponse{
	...
	TestRequestEthGetAccountsEmpty: {
		RequestBody: `{
			"jsonrpc":"2.0",
			"method":"eth_accounts",
			"params":[],
	...
	TestRequestEthBlockByNumberLatest: {
		RequestBody: `{
			"jsonrpc":"2.0",
			"method":"eth_getBlockByNumber",
			"params":[
	...
	TestRequestEthBlockByNumberFuture: {
		RequestBody: `{
			"jsonrpc":"2.0",
			"method":"eth_getBlockByNumber",
			"params":[
	...
	TestRequestEthBlockByNumberError: {
		RequestBody: `{
			"jsonrpc":"2.0",
			"method":"eth_getBlockByNumber",
			"params":[
	...
	TestRequestEthGetBalancePositive: {
		RequestBody: `{
			"jsonrpc":"2.0",
